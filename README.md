...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/h2o-py-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9952&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/h2o-py-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `h2o-py` can be installed with:

```
conda install h2o-py
```

It is possible to list all of the versions of `h2o-py` available on your platform with:
